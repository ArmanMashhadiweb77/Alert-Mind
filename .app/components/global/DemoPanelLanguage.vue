        ...
        <div class="relative my-4 flex items-center justify-center">
          <div class="relative">
            ...
            >
              <img
                class="size-10 rounded-full"
                src="/img/avatars/united-states-of-america.svg"
                alt="flag icon"
              >
            </div>
            <div
