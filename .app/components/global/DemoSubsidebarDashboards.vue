...
import { useSidebar } from '../../../layers/tairo-layout-sidebar/composables/sidebar'
...
<template>
  <TairoSubsidebar>
    ...
    <TairoSubsidebarMenu v-if="current.subsidebar" :navigation="current.subsidebar.props.navigation" />
  </TairoSubsidebar>
</template>
